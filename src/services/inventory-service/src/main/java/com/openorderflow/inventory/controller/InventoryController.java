...
public class InventoryController {
    ...
    public ResponseEntity<InventoryDto> getAllByBusinessOutlet(@PathVariable UUID outletId, Boolean includeItems) {
        return ResponseEntity.ok(inventoryService.getByBusinessOutlet(outletId, includeItems));
    }
